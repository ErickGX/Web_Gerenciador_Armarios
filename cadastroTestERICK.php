 ...
 <html>
    ...
    <body>
        ...
        <h1>Teste inserir com sql</h1>
         ...
         <form method="POST" action="ValidaCadastro.php"><br> <br>
            ...
            <input type="text" name="cpf" id="" placeholder="bota cpf ae" required><br>

            <input type="password" name="senha" id="" placeholder="bota senha ae" required><br>

            <input type="text" name="modulo" id="" placeholder="bota modulo ae" required><br>

            
            <input type="text" name="periodo" id="" placeholder="bota periodo ae" required><br>

            <input type="text" name="matricula" id="" placeholder="situacao matricula" required><br>
